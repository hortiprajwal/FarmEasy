            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Farm Easy',style: GoogleFonts.poppins(color: Colors.white,fontSize:32),)
                ],
              ),
            ),
          ),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(child: Text('Farm Easy has calculated and here are the results!',style: GoogleFonts.poppins(fontSize: 16,color: Colors.white),)),
                        ],
                      ),
