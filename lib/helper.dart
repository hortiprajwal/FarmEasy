...
class HelperState extends State<Helper> {
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                      child: Text(
                                    'Farm Easy has calculated and here are the results!',
                                    style: GoogleFonts.poppins(
  ...
  int getData()  {
    ...
    if(pesticide_count >= 0 && pesticide_count <=2){
      if(pesticide_week <= 8){
        res = 0;
      }
      else if(pesticide_week > 8 && pesticide_week <=12){
        res = 1;
      }
      else{
        res = 0;
    ...
    else if(pesticide_count >2 && pesticide_count <= 5){
      if(pesticide_week <=8){
        res = 1;
      }
      else if(pesticide_week > 8){
        res = 2;
      }
      else{
        res = 2;
  ...
  Future<int> getdata() async{
    ...
    final url = Uri.parse('http://127.0.0.1:5000/predict?a=1575&b=$type_of_crop&c=$soil_type&d=$pesticide_count&e=$pesticide_week&f=${random.nextInt(50)}&g=$a1&h=$a2&i=$a3&k=0&l=0&m=1');
    print(url);
