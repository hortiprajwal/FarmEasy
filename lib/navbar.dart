...
import 'package:loginpage/about_us.dart';
...
class FarmEasy extends StatefulWidget {
  const FarmEasy({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return FarmEasyState();
  }
}

class FarmEasyState extends State<FarmEasy> {
  int currentIndex = 0;
