...
class WeatherState extends State<Weather> {
  ...
  Future<List<forecast>> getweather() async {
    ...
    Response r = await get(Uri.parse('https://api.openweathermap.org/data/2.5/onecall?lat=13.3524&lon=74.7868&exclude=hourly,minutely&appid=7811faccb2a742cf12b3ee229ec9fcf8'));
    //print(r.body);
    Map<String, dynamic> x = json.decode(r.body);
    //print(x['current']);
    weather.add(current(
        x['current']['temp'],
